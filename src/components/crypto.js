...
const encoding = 'hex'
const JSON_encrypt_pwd = process.env.REACT_APP_CRYPTO_JSON_PWD
const isJSON = (supJ) => {
    try {
        JSON.parse(supJ);
        return true;
...
/**
* @dev responsible for verifying that object[key] parsed version of an originally stringified nested object doesnt contain any nested stringified object that should be rendered as a plain
